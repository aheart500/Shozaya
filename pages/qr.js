    ...
    <div className={styles.container}>
      ...
      >
        ...
        <div className="form">
          ...
          <div className="links">
            <div style={{ width: "100%" }}>
              <Link href="//www.shozaya.com/">
                <a className="link">
                  <div className="icon first-icon"></div>
                  <div className="data">
                    <p className="header-p">Visit Shozaya Online</p>
            ...
            <div style={{ width: "100%" }}>
              <Link href="//www.facebook.com/Dolapk-104464171080724/">
                <a className="link">
                  <div className="icon second-icon"></div>
                  <div className="data">
                    <p className="header-p">Facebook</p>
                    <p className="subtitle-p">Become a fan for Shozaya</p>
                  </div>
                </a>
              </Link>
            </div>
              ...
              <Link href="//www.instagram.com/dolapk_">
                <a className="link">
                  ...
                  <div className="data">
                    ...
                    <p className="subtitle-p">Follow Shozaya</p>
                  </div>
                </a>
              </Link>
            </div>
